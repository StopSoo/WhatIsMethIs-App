...
class MedicationController {
  ...
  Future<List<Medication>> fetchMedicationInfo(int page) async {
    ...
    String url = '$baseUrl/medications/all/$page';
  ...
  Future<void> deleteMedicationInfo(List<int> medicationIds) async {
    ...
    print(queryParams);
    String url = '$baseUrl/medications?';
  ...
  Future<Medication> fetchMedicationInfoIndex(int index) async {
    //Todo: 로그인 구현되면 받아오는걸로 수정하기
    Map<String, String> headers = {'Content-Type': 'application/json', 'Accept': 'application/json', 'X-ACCESS-TOKEN': accessToken};

    String url = '$baseUrl/medications/$index';
    final response = await http.get(Uri.parse(url), headers: headers);
  ...
  Future<void> editMedicationInfoIndex(int index, Medication medication) async {
    //Todo: 로그인 구현되면 받아오는걸로 수정하기
    Map<String, String> headers = {'Content-Type': 'application/json', 'Accept': 'application/json', 'X-ACCESS-TOKEN': accessToken};
    ...
    String url = '$baseUrl/medications/$index';
    final response = await http.patch(Uri.parse(url), headers: headers, body: medicationJson);
  ...
  Future<void> registerMedicationInfoIndex(Medication medication) async {
    //Todo: 로그인 구현되면 받아오는걸로 수정하기
    Map<String, String> headers = {'Content-Type': 'application/json', 'Accept': 'application/json', 'X-ACCESS-TOKEN': accessToken};
    ...
    String url = '$baseUrl/medications';
    final response = await http.post(Uri.parse(url), headers: headers, body: medicationJson);
